...
public class SearchUser {
    ...
    static String rutaArchivoDeExcel = "C:\\Users\\maria.espinosa\\Downloads\\Orange\\orage.xlsx";
    ...
    public static void abrirPagina() {
        ...
        System.setProperty("webdriver.chrome.driver", "C:\\Users\\maria.espinosa\\Downloads\\Orange\\chromedriver.exe");
        //Declara el robor
        Aleja = new ChromeDriver();
        //Enlace que se copia al abrir el navegador
        Aleja.get("https://opensource-demo.orangehrmlive.com/");
        //Maximixa la pagina
